...
document.onreadystatechange = function () {
  if (document.readyState == "complete") {
    // 设备适配
    var deviceFlex = function deviceFlex() {
    ...
    var errorTips = function errorTips(content) {
    ...
    var successTips = function successTips(content) {
      $(".tips-progress").css("width", "100%");
    ...
    var inputChange = function inputChange(ele) {
      var __this = ele;
      __this.dataset.search = __this.value;
    }; // 搜索


    var searchContent = function searchContent(searchButton) {
    ...
    var goToArticle = function goToArticle(pageNum) {
      $.ajax({
        type: "GET",
